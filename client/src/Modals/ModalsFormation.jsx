...
function Edite(props) {
    return (
        <div className="modal fade" id="edite_formation" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered">
                <form className="modal-content" onSubmit={props.onSubmit}>
                    <div className="modal-header">
                    ...
                    <div className="modal-body">
                        <div className="form-floating text-muted">
                            <input onChange={props.onChange} value={props.value.name} className="form-control shadow-none" type='text' id='name' name='name' placeholder='Name' />
                            <label htmlFor='name'>Name</label>
                        </div>
                        <div className="form-floating text-muted mt-3">
                            <input onChange={props.onChange} value={props.value.dateDebut} className="form-control shadow-none" type='date' id='dateDebut' name='dateDebut' placeholder='Date Debut' />
                            <label htmlFor='dateDebut'>Date Debut</label>
                        </div>
                        <div className="form-floating text-muted mt-3">
                            <input onChange={props.onChange} value={props.value.dateFin} className="form-control shadow-none" type='date' id='dateFin' name='dateFin' placeholder='Date Fin' />
                            <label htmlFor='dateFin'>Date Fin</label>
                        </div>
                        <div className="form-floating text-muted mt-3">
                            <input onChange={props.onChangeFile} className="form-control shadow-none" type='file' id='image' name='image' placeholder='Image' />
